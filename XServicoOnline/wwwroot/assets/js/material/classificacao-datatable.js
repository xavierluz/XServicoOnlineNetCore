Classificacao = (function () {
    ...
    let tableName = '#tableClassificacao';
    let actionDetalhes = '.action-detalhe';
    let actionEditar = '.action-editar';
    let actionId = '.classificacao-id';

    Classificacao.prototype.Load = function () {
        criarTableClassificacao();
    ...
    var editarClickHandler = function (categoria) {
        window.location = './EditarClassificacao?classificacaoId=' + categoria.id; 
    };
    var criarTableClassificacao = function () {
