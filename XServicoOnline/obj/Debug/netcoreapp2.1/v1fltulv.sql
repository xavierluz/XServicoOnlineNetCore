...
CREATE SEQUENCE dbo."SEQ_GENERATED_FUNCAO_REIVINDICAO_ID" START WITH 100 INCREMENT BY 1 NO MINVALUE NO MAXVALUE NO CYCLE;

CREATE SEQUENCE dbo."SEQ_GENERATED_USUARIO_REIVINDICAO_ID" START WITH 100 INCREMENT BY 1 NO MINVALUE NO MAXVALUE NO CYCLE;
...
CREATE TABLE dbo."FuncaoReivindicacao" (
    "Id" integer NOT NULL DEFAULT (SEQ_GENERATED_FUNCAO_REIVINDICAO_ID),
...
CREATE TABLE dbo."UsuarioReivindicacao" (
    "Id" integer NOT NULL DEFAULT (SEQ_GENERATED_USUARIO_REIVINDICAO_ID),
    "UsuarioId" character varying(100) NOT NULL,
    "TipoReivindicacao" character varying(100) NULL,
    "ValorReivindicacao" character varying(200) NULL,
...
VALUES ('20181214115727_migrationUsuario', '2.1.2-rtm-30932');
